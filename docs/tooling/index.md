---
title: Tooling Docs
description: Map of tooling subdomain documentation.
updateAt: 2026-07-01
---

# Tooling Docs

Use these docs when changing package management, dependency policy, or quality tooling.

## Subdomains

- [Package Management](./package-management.md): Consult for pnpm usage, lockfile policy, build approvals, and dependency overrides.
- [Quality Gates](./quality-gates.md): Consult for Ultracite, Biome, and verification command expectations.
