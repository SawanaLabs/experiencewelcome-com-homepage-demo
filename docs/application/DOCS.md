...
- `src/app/[locale]/(home)/page.tsx` owns the current localized homepage route entrypoint and page composition.
- `src/components/homepage/` owns ExperienceWelcome homepage section components.
