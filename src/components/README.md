...
- Prefer native elements for simple controls and Base UI-backed shadcn-style source for interactive primitives such as dropdowns, menus, selects, popovers, dialogs, tabs, and tooltips.
